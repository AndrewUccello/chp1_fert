...
t.test(f10$lignin.2019, f10$lignin.2018, mu=0, alternative = "less")
t.test(f10$CN.2021, f10$CN.2018, mu=0, alternative = "less")

Chp1_fert_data_clean %>%
      ggplot(aes(x = year, y = BSI)) +
      geom_point() +
